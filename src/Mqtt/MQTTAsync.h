...
void onSend(void* context, MQTTAsync_successData* response)
{
	...
	opts.onSuccess = on_mqtt_disconnect;
	opts.context = client;
...
int main(int argc, char* argv[])
{
	...
	MQTTAsync_setCallbacks(client, NULL, on_mqtt_connlost, NULL, NULL);
...
int on_mqtt_received(void *context, char *topicName, int topicLen, MQTTAsync_message *message)
{
    int i;
    char* payloadptr;
...
int main(int argc, char* argv[])
{
	...
	disc_opts.onSuccess = on_mqtt_disconnect;
