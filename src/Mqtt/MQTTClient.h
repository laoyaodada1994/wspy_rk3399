...
int on_mqtt_received(void *context, char *topicName, int topicLen, MQTTClient_message *message)
{
    int i;
    char* payloadptr;
...
int main(int argc, char* argv[])
{
    ...
    MQTTClient_setCallbacks(client, NULL, on_mqtt_connlost, on_mqtt_received, delivered);
