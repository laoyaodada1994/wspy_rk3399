...
C_SRCS += \
../src/tmp/mqtt/src/Mqtt/MqttProcess.c 

OBJS += \
./src/tmp/mqtt/src/Mqtt/MqttProcess.o 

C_DEPS += \
./src/tmp/mqtt/src/Mqtt/MqttProcess.d 


# Each subdirectory must supply rules for building sources it contributes
src/tmp/mqtt/src/Mqtt/%.o: ../src/tmp/mqtt/src/Mqtt/%.c
	@echo 'Building file: $<'
